...
<title>My Profile — TrackMySpend</title>
...
<style>
  ...
  *{ margin:0; padding:0; box-sizing:border-box; }
  ...
  /* subtle cloth texture on cover sections — identical to landing page */
  .cover-bg{
    background:
  ...
  .nav-links{ display:flex; gap:20px; font-size:0.86rem; color:var(--paper); }
  .nav-links a{ position:relative; opacity:0.68; transition:opacity 0.2s; padding-bottom:4px; }
  ...
  .btn{
    padding:13px 24px; border-radius:5px; font-weight:600; font-size:0.92rem;
    display:inline-flex; align-items:center; justify-content:center; gap:8px;
    transition: transform 0.15s ease, box-shadow 0.15s ease, background 0.15s ease;
    cursor:pointer; border:none;
  }
  .btn-primary{ background:var(--money); color:var(--paper); box-shadow:0 3px 0 var(--money-deep); }
  .btn-primary:hover{ transform:translateY(-2px); box-shadow:0 5px 0 var(--money-deep); }
  .btn-primary:active{ transform:translateY(1px); box-shadow:0 2px 0 var(--money-deep); }
  .btn-primary:disabled{ opacity:0.55; cursor:not-allowed; transform:none; box-shadow:0 3px 0 var(--money-deep); }
  .btn-ghost{ border:1px solid var(--line); color:var(--ink); background:transparent; }
  .btn-ghost:hover{ background:rgba(28,38,32,0.05); }
  .btn-ghost-dark{ border:1px solid var(--line-on-cover); color:var(--paper); background:transparent; }
  .btn-ghost-dark:hover{ background:rgba(244,239,225,0.06); }
  .btn-danger{ background:transparent; color:var(--stamp); border:1px solid rgba(177,70,47,0.4); }
  .btn-danger:hover{ background:rgba(177,70,47,0.08); }
  .btn-block{ width:100%; }

  /* ---------- SECTION SHARED ---------- */
  section{ position:relative; }
  .section-pad{ padding:72px 0 100px; }
  .kicker{
  ...
  .page-sub{
    margin-top:12px; font-size:1rem; line-height:1.6; color:rgba(244,239,225,0.66);
    max-width:520px;
  }

  /* ---------- PROFILE HEADER CARD (passbook styling) ---------- */
  .profile-hero{
    margin-top:44px;
    background:var(--paper);
    border-radius:10px;
  ...
  .avatar{
    ...
    background:linear-gradient(135deg, var(--money), var(--money-deep));
    color:var(--paper);
    display:flex; align-items:center; justify-content:center;
    font-family:'Fraunces', serif; font-weight:600; font-size:1.9rem;
    box-shadow:0 4px 0 var(--money-deep);
    position:relative;
  }
  .avatar-edit{
  ...
  .profile-id .name{ font-family:'Fraunces', serif; font-weight:600; font-size:1.5rem; color:var(--ink); }
  .profile-id .email{ font-family:'IBM Plex Mono', monospace; font-size:0.84rem; color:var(--ink-soft); margin-top:4px; }
  .profile-id .since{ font-family:'IBM Plex Mono', monospace; font-size:0.72rem; letter-spacing:0.06em; text-transform:uppercase; color:var(--ink-soft); margin-top:10px; }
  .profile-hero .btn-ghost{ flex:none; }
  ...
  .stat-card{
    background:var(--cover-deep); padding:22px 24px;
  }
  .stat-card .stat-label{ font-family:'IBM Plex Mono', monospace; font-size:0.68rem; letter-spacing:0.08em; text-transform:uppercase; color:rgba(244,239,225,0.5); }
  .stat-card .stat-value{ font-family:'Fraunces', serif; font-weight:600; font-size:1.6rem; color:var(--paper); margin-top:6px; }
  ...
  .panel-title{
    font-family:'Fraunces', serif; font-weight:600; font-size:1.15rem; margin-bottom:4px;
  }
  .panel-desc{ font-size:0.86rem; color:var(--ink-soft); margin-bottom:24px; }
  ...
  .field input, .field select{
    ...
    color:var(--ink); font-family:'IBM Plex Sans', sans-serif; font-size:0.92rem;
    transition: border-color 0.15s ease, background 0.15s ease;
  }
  .field input:focus, .field select:focus{
    outline:none; border-color:var(--money); background:#fff;
  }
  .field input:disabled{ color:var(--ink-soft); cursor:not-allowed; }
  .field .field-note{ font-size:0.76rem; color:var(--ink-soft); margin-top:6px; }

  .panel-actions{ display:flex; gap:12px; margin-top:8px; flex-wrap:wrap; }
  ...
  .side-list .item-title{ font-weight:600; color:var(--ink); }
  .side-list .item-sub{ font-size:0.78rem; color:var(--ink-soft); margin-top:2px; }
  .side-list a{ font-family:'IBM Plex Mono', monospace; font-size:0.76rem; color:var(--money-deep); font-weight:600; }
  .side-list a:hover{ text-decoration:underline; }

  .danger-panel{
    margin-top:28px; background:var(--cover-deep); border:1px solid rgba(177,70,47,0.35);
    border-radius:10px; padding:26px 28px;
  }
  .danger-panel .panel-title{ color:var(--stamp); }
  .danger-panel .panel-desc{ color:rgba(244,239,225,0.6); }

  .success-banner{
    display:none;
    margin-top:20px; padding:14px 16px; border-radius:6px;
    background:rgba(63,122,92,0.12); border:1px solid var(--money);
    color:var(--money-deep); font-size:0.85rem; font-family:'IBM Plex Mono', monospace;
  }
  .success-banner.show{ display:block; }

  footer{
    background:var(--paper); border-top:1px solid var(--line);
    padding:34px 0 40px; margin-top:20px; border-radius:16px 16px 0 0;
  }
  .footer-inner{ display:flex; justify-content:space-between; align-items:center; color:var(--ink-soft); font-size:0.82rem; flex-wrap:wrap; gap:16px; max-width:1180px; margin:0 auto; padding:0 32px;}
  ...
  @media (max-width: 640px){
    ...
    .profile-hero .btn-ghost{ width:100%; }
  }
  @media (max-width: 560px){
    .wrap{ padding:0 20px; }
    .profile-hero-inner{ padding:28px 22px 28px 46px; }
    .profile-hero::before{ width:24px; }
...
<section class="cover-bg section-pad">
  <div class="wrap">
    <div class="eyebrow">Account</div>
    <h1>My <em>profile</em></h1>
    <p class="page-sub">Manage your personal details, currency preferences, and account security in one place.</p>

    <div class="profile-hero">
      <div class="profile-hero-inner">
        <div class="avatar">
          RS
          <div class="avatar-edit" title="Change photo">&#9998;</div>
        </div>
        <div class="profile-id">
          <div class="name">Riya Sharma</div>
          <div class="email">riya.sharma@example.com</div>
          <div class="since">Member since Aug 2026</div>
        </div>
        <a href="change-password.html" class="btn btn-ghost">Change password</a>
      </div>
    </div>
    ...
    <div class="panel-grid">
      <div class="panel">
        ...
        <div class="panel-desc">This information is used across your dashboard, reports, and reminders.</div>

        <form id="profileForm">
          <div class="field-grid">
            <div class="field">
              <label for="firstName">First name</label>
              <input type="text" id="firstName" name="firstName" value="Riya" required>
            </div>
            <div class="field">
              <label for="lastName">Last name</label>
              <input type="text" id="lastName" name="lastName" value="Sharma" required>
            </div>
            <div class="field full">
              <label for="email">Email address</label>
              <input type="email" id="email" name="email" value="riya.sharma@example.com" required>
              <div class="field-note">Used for sign-in and account notifications.</div>
            </div>
            <div class="field">
            ...
            <div class="field">
              <label for="monthStart">Budget month starts on</label>
      ...
      <div>
        <div class="panel">
          ...
          <div class="panel-desc">Security and access settings for your account.</div>
          <ul class="side-list">
            <li>
              <div>
                <div class="item-title">Password</div>
                <div class="item-sub">Last changed 3 months ago</div>
              </div>
              <a href="change-password.html">Change</a>
            </li>
            <li>
              <div>
                <div class="item-title">Two-factor authentication</div>
                <div class="item-sub">Not enabled</div>
              </div>
              <a href="#">Enable</a>
            </li>
            <li>
              <div>
                ...
                <div class="item-sub">1 active session</div>
              </div>
              <a href="#">Manage</a>
            </li>
            <li>
              <div>
                <div class="item-title">Export my data</div>
                <div class="item-sub">Download as CSV</div>
              </div>
              <a href="#">Export</a>
            </li>
          </ul>
        ...
        <div class="danger-panel">
          ...
          <div class="panel-desc">Deleting your account permanently removes all transactions, goals, and reports. This cannot be undone.</div>
...
<footer>
  <div class="footer-inner">
    ...
    <div>Built as a First Year B.Tech internship project &middot; 2026</div>
  </div>
</footer>
...
<script>
  ...
  form.addEventListener('submit', (e) => {
    e.preventDefault();
    // Placeholder for API call to persist profile changes
    successBanner.classList.add('show');
    setTimeout(() => successBanner.classList.remove('show'), 4000);
  });

  document.getElementById('deleteAccountBtn').addEventListener('click', () => {
    const confirmed = confirm('This will permanently delete your account and all associated data. Are you sure?');
    if(confirmed){
      // Placeholder for API call to delete the account
