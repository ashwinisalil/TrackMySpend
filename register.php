...
<title>Create your account — TrackMySpend</title>
...
<div class="page">
  ...
  <div class="brand-panel">
    ...
    <div class="brand-mid">
      ...
      <h1>Start your own <em>passbook</em>, in under a minute.</h1>
      <p>One place to log income and expenses, sort them into categories, and watch your savings goals actually move.</p>
    </div>

    <div class="brand-points">
      <div class="bp">
        <div class="bp-mark">✓</div>
        <p><strong>Free to start</strong> — no card required, ever.</p>
      </div>
      <div class="bp">
        <div class="bp-mark">✓</div>
        <p><strong>Your data, your device</strong> — export anytime, no lock-in.</p>
      </div>
      <div class="bp">
        <div class="bp-mark">✓</div>
        <p><strong>Built for everyday spending</strong> — rupees, not jargon.</p>
      </div>
    </div>
  ...
  <div class="form-panel">
    <div class="form-card">
      <div class="form-head">
        ...
        <p>Already tracking with us? <a href="login.html">Log in instead</a></p>
      </div>
      ...
      <form id="regForm" novalidate>
        <div class="field-row">
          <div class="field">
            ...
            <input type="text" id="fname" name="fname" placeholder="Riya" required>
          </div>
          <div class="field">
        ...
        <div class="field">
          ...
          <div class="strength" id="strengthBar">
        ...
        <div class="field">
          ...
          <div class="input-wrap">
            ...
            <button type="button" class="toggle-pass" id="toggleConfirm">Show</button>
          </div>
        ...
        <div class="stamp-note" id="stampNote">Entry recorded — welcome to your first page.</div>
...
<script>
  ...
  const colors = ['#b1462f', '#c9a15a', '#7a9a5c', '#3f7a5c'];
  ...
  password.addEventListener('input', () => {
    const score = password.value.length ? Math.max(1, scorePassword(password.value)) : 0;
    bars.forEach((b, i) => {
      b.style.background = i < score ? colors[score-1] : 'var(--line)';
    });
    strengthLabel.textContent = password.value.length ? labels[score-1] : 'Password strength';
    checkConfirm();
  });

  function checkConfirm(){
    if(!confirm.value){ confirmHint.textContent=''; confirm.classList.remove('err'); return; }
    if(confirm.value !== password.value){
      confirmHint.textContent = 'Doesn\u2019t match your password yet.';
  ...
  toggle(confirm, document.getElementById('toggleConfirm'));
  ...
  document.getElementById('regForm').addEventListener('submit', (e) => {
    ...
    if(password.value === confirm.value && password.value.length >= 8 && document.getElementById('terms').checked){
